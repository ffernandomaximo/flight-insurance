...
library DateLib {
    ...
    function fromTimestamp(uint _timestamp) public pure returns (DateTime memory) { 
    ...
    function toUnixTimestamp(DateTime memory _date) public pure returns (uint timestamp) {
        uint16 i;
